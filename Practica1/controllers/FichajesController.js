...
const fichajesIdFichajeDELETE = async (request, response) => {
  await Controller.handleRequest(request, response, service.fichajesIdFichajeDELETE);
};

const fichajesIdFichajePUT = async (request, response) => {
  await Controller.handleRequest(request, response, service.fichajesIdFichajePUT);
};
