...
const usuariosIdUsuarioDELETE = async (request, response) => {
  await Controller.handleRequest(request, response, service.usuariosIdUsuarioDELETE);
};

const usuariosIdUsuarioGET = async (request, response) => {
  await Controller.handleRequest(request, response, service.usuariosIdUsuarioGET);
};

const usuariosIdUsuarioPUT = async (request, response) => {
  await Controller.handleRequest(request, response, service.usuariosIdUsuarioPUT);
};
